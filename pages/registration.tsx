...
const Basic = () => {
    ...
    const validationSchema = yup.object({
        username: yup.string().min(5, "Минимальная длина 5 символов").required("Введите имя пользователя"),
        password: yup.string().min(6, "Минимальная длина 6 символов").max(32, "Максимальная длина 32 символа").required("Введите пароль"),
    });
